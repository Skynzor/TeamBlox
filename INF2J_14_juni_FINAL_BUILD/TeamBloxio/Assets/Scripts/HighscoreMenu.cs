...
public class HighscoreMenu : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        PlayerPrefs.SetInt("highScore1", 100);
        PlayerPrefs.SetString("highScoreName1", "test1");

        PlayerPrefs.SetInt("highScore2", 300);
        PlayerPrefs.SetString("highScoreName2", "test2");

        PlayerPrefs.SetInt("highScore3", 200);
        PlayerPrefs.SetString("highScoreName3", "test3");

        PlayerPrefs.SetInt("highScore4", 5000);
        PlayerPrefs.SetString("highScoreName4", "test4");

        PlayerPrefs.SetInt("highScore5", 500);
        PlayerPrefs.SetString("highScoreName5", "test5");
